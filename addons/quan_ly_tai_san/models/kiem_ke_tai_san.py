...
class KiemKeTaiSan(models.Model):
    ...
    don_vi_id = fields.Many2one('don_vi', string='Bộ phận cần kiểm kê', required=True, ondelete='cascade')
    ...
    @api.depends('don_vi_id', 'ds_kiem_ke_ids')
